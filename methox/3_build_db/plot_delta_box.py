...
plt.xlim(-40,60)
#plt.title(" ")
bpl = sns.boxplot(data=df, ax=axs, x='energy', y='idx', linewidth=0.7, color='yellow')
bpl.set(xlabel=r"$\Delta E (kcal/mol)$")
axs.axes.yaxis.set_visible(False)
plt.savefig('box_delta.png', dpi=200, transparent=True)
plt.clf()
